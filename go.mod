...
require (
	...
	github.com/here-Leslie-Lau/mongo-plus v1.0.7
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.873
...
require (
	...
	github.com/cohere-ai/cohere-go/v2 v2.7.1 // indirect
